...
LICENSE="BSD"
SLOT="0"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~mips ~ppc64 ~s390 ~sh ~sparc ~x86 ~x86-fbsd ~x86-freebsd ~x86-interix ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~x64-solaris ~x86-solaris"
...
src_prepare() {
	...
	# Apply changest r8696 solving http://projects.scipy.org/numpy/ticket/1605
	# an interaction problem with cython.
	epatch "${FILESDIR}"/${P}-r8696.patch
