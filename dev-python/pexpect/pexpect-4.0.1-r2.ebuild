...
PATCHES=(
	"${FILESDIR}"/${PN}-4.0.1_superfluous_sleep.patch
	"${FILESDIR}"/${PN}-4.0.1-none_delaybeforesend.patch
	"${FILESDIR}"/${PN}-4.0.1-read_more_bytes.patch
	"${FILESDIR}"/${PN}-4.0.1-spawnpty.patch
	)
