...
# $Header: /var/cvsroot/gentoo-x86/dev-python/ipython/ipython-1.2.1.ebuild,v 1.1 2014/03/07 11:34:51 jlec Exp $
...
PATCHES=(
	...
	"${FILESDIR}"/0001-Allow-InputTransformers-to-raise-SyntaxErrors.patch
)
