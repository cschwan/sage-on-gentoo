...
pkg_postinst() {
	...
	einfo "atlasrep"
	einfo "There is an issue with that package in that it"
	einfo "tries to write files in a system location if"
	einfo "installed a system package."
	einfo "Alternatively atlasrep can be installed safely"
	einfo "in a default user location. Namely ~/.gap, where"
