...
BDEPEND="$(python_gen_any_dep '
	...
	~sci-mathematics/sage-10.1[${PYTHON_USEDEP},jmol]
	~sci-mathematics/sage_docbuild-10.1[${PYTHON_USEDEP}]
	')
...
python_check_deps() {
	...
	python_has_version -b "~sci-mathematics/sage-10.1[${PYTHON_USEDEP},jmol]" &&
	python_has_version -b "~sci-mathematics/sage_docbuild-10.1[${PYTHON_USEDEP}]" &&
