...
src_install() {
	...
	local sage_doc="/usr/share/doc/sage/"
	dodir ${sage_doc}output/doctrees/en/tutorial
	dodir ${sage_doc}en/tutorial/templates
	dodir ${sage_doc}en/tutorial/static
	dodir ${sage_doc}en/reference/templates
	dodir ${sage_doc}en/reference/static
