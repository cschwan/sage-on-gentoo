...
src_prepare() {
	...
	# sage-on-gentoo, sage trac #16894
	epatch "${FILESDIR}"/${PN}-2.7.1-nffactor.patch
	# sage-on-gentoo, sage trac 14894 - actual upstream backport
	epatch "${FILESDIR}"/${PN}-2.7.1-cb_pari_err_handle.patch
