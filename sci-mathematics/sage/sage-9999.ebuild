...
python_prepare() {
	...
	eapply "${FILESDIR}"/${PN}-6.9-exec.patch
	eprefixify bin/sage
	...
	eapply "${FILESDIR}"/${PN}-6.10-sources.patch
	...
	eapply "${FILESDIR}"/${PN}-6.8-env.patch
	...
	eapply "${FILESDIR}"/${PN}-6.3-doc_common.patch

	# fix location of the html doc
	eapply "${FILESDIR}"/${PN}-6.10-sagedoc-r2.patch
