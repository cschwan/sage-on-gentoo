...
# TODO: Need sci-libs/m4ri-20091120 but is not available on upstream
CDEPEND="
	>=dev-libs/mpfr-2.4.1
	|| (
...
# 	sage_package_patch "sage-${PV}" "${FILESDIR}/${P}-documentation.patch"
	...
	sage_package_patch r-2.9.2 "${FILESDIR}/sage-4.2.1-use-R-from-portage.patch"
	...
	sage_package_nested_patch r-2.9.2 rpy2-2.0.6 \
		"${FILESDIR}/sage-4.2.1-fix-rpy2.patch"
...
# 		setup.py
	...
	if use amd64 ; then
		sage_package_patch "sage-${PV}" "${FILESDIR}/sage-4.2.1-amd64-hack.patch"
	fi
